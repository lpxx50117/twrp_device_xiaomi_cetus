...
#Init
TARGET_INIT_VENDOR_LIB := //$(DEVICE_PATH):libinit_cetus
TARGET_RECOVERY_DEVICE_MODULES := libinit_cetus
...
TW_LOAD_VENDOR_MODULES := "msm_drm.ko fts_touch_spi_k8.ko fts_touch_pri.ko fts_touch_sec.ko adsp_loader_dlkm.ko qti_battery_charger_main_odin.ko qti_battery_charger_main.ko exfat.ko"
